...
policy_model = dict(
    ...
    pts_bbox_head=dict(
        ...
        valid_fut_ts=6,
        plan_anchors_path='/home/whut613/zjy/zjy/vad_rl/Bench2DriveZoo/farthest_point_sampling_256.npy',  #'./gt_trajs.npy',
        ego_bev_decoder=dict(
        ...
        loss_plan_map_theta=dict(type='PlanMapDirectionLoss', loss_weight=0.0),  # fake idx
...
data_root = "/home/whut613/zjy/zjy/vad_rl/Bench2DriveZoo/data/bench2drive"
info_root = "/home/whut613/zjy/zjy/vad_rl/Bench2DriveZoo/data/infos"
map_root = "/home/whut613/zjy/zjy/vad_rl/Bench2DriveZoo/data/bench2drive/maps"
map_file = "/home/whut613/zjy/zjy/vad_rl/Bench2DriveZoo/data/infos/b2d_map_infos.pkl"
...
multi_step = 1
use_per = True
log_dir = '/home/whut613/zjy/b2d_rl/work_dir'
squash = True