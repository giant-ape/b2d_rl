...
class LazyMemory(dict):
    ...
    def _sample(self, indices, batch_size):
        ...
        for i, index in enumerate(indices):
            ...
            states.append(self['state'][_index]) 
            next_states.append(self['next_state'][_index])
...
class LazyMultiStepMemory(LazyMemory):
    ...
    def __init__(self, capacity, device, gamma=0.99,
                 multi_step=3):
...
class LazyPrioritizedMultiStepMemory(LazyMultiStepMemory):
    ...
    def __init__(self, capacity, device, gamma=0.99,
        ...
        super().__init__(capacity, device, gamma, multi_step)
    ...
    def get_priorities(self):
        ...
        for i in range(self._n):
            priorities.append(self.it_sum[i])
        return priorities
