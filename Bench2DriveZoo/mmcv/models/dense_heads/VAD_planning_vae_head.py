...
from mmcv.models.generator import DistributionModule, PredictModel
from mmcv.models.generator import FuturePrediction
...
class VADPlanningHead(DETRHead):
    """Head of VAD model.
    Args:
    ...
    def __init__(self,
        ...
        if map_class_weight is not None and (self.__class__ is VADPlanningHead):
        ...
        super(VADPlanningHead, self).__init__(*args, transformer=transformer, **kwargs)
