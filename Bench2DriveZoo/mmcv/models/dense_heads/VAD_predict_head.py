...
class VADPredictHead(DETRHead):
    ...
    def __init__(self,
        ...
        if map_class_weight is not None and (self.__class__ is VADPredictHead):
        ...
        super(VADPredictHead, self).__init__(*args, transformer=transformer, **kwargs)
