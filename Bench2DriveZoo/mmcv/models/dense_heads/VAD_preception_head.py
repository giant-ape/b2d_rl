...
class VADPreceptionHead(DETRHead):
    """Head of VAD model.
    Args:
    ...
    def __init__(self,
        ...
        if map_class_weight is not None and (self.__class__ is VADPreceptionHead):
        ...
        super(VADPreceptionHead, self).__init__(*args, transformer=transformer, **kwargs)
