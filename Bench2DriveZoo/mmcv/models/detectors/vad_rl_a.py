...
class VAD_RL_A(MVXTwoStageDetector):
    """VAD model.
    """
    def __init__(self,
                 use_grid_mask=False,
    ...
    def forward_pts_train(self,
        ...
        outs = self.pts_bbox_head(pts_feats, img_metas, prev_bev,
                                  ...
                                  command_wp = ego_fut_trajs[:,:,0],
                                  target_point = ego_fut_trajs[0,:,0],
                                  command_id = ego_fut_cmd, ego_fut_trajs=ego_fut_trajs,
                                  cf_img=cf_img)
    ...
    def forward(self, inputs,return_loss=True,rescale=False):
        ...
        #     return outputs
        # else:
        #     outputs, prev_frame_info = self.forward_test(**inputs,rescale=rescale)            
        #     return outputs, prev_frame_info
        a=1
    ...
    def explore(self, inputs, rescale=False):
        outputs, prev_frame_info = self.forward_test(**inputs,rescale=rescale)            
        return outputs, prev_frame_info
    ...
    def forward_train(self,
        ...
        losses_pts = self.forward_pts_train(img_feats, gt_bboxes_3d, gt_labels_3d,
                                            ...
                                            cf_img=img.clone()[0][:,208:208+320,432:432+416])
    ...
    def forward_test(
        ...
        **kwargs
        ...
        return bbox_results, self.prev_frame_info
    ...
    def simple_test_pts(
        ...
        outs = self.pts_bbox_head(x, img_metas, prev_bev=prev_bev,
                                  ego_his_trajs=ego_his_trajs, ego_lcf_feat=ego_lcf_feat,target_point=target_point)
