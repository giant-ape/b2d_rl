...
class VAD_RL_Q(MVXTwoStageDetector):
    """VAD model.
    """
    def __init__(self,
                 use_grid_mask=False,
    ...
    def forward(self, inputs, ego_plan_traj):
        ...
        outs = self.pts_bbox_head(img_feats, img_metas, prev_bev=prev_frame_info['prev_bev'],
                                  ...
                                  ego_plan_traj=ego_plan_traj, target_point = target_point)
